...
def get_path():
    return os.path.abspath(os.path.join(CWD, args.brainlearn_path))
...
class TestCLI(metaclass=OrderedClassMembers):
    ...
    def beforeEach(self):
        self.brainlearn = None

    def afterEach(self):
        assert postfix_check(self.brainlearn.get_output()) == True
        self.brainlearn.clear_output()

    def test_eval(self):
        self.brainlearn = Brainlearn("eval".split(" "), True)
        assert self.brainlearn.process.returncode == 0

    def test_go_nodes_1000(self):
        self.brainlearn = Brainlearn("go nodes 1000".split(" "), True)
        assert self.brainlearn.process.returncode == 0

    def test_go_depth_10(self):
        self.brainlearn = Brainlearn("go depth 10".split(" "), True)
        assert self.brainlearn.process.returncode == 0

    def test_go_perft_4(self):
        self.brainlearn = Brainlearn("go perft 4".split(" "), True)
        assert self.brainlearn.process.returncode == 0

    def test_go_movetime_1000(self):
        self.brainlearn = Brainlearn("go movetime 1000".split(" "), True)
        assert self.brainlearn.process.returncode == 0

    def test_go_wtime_8000_btime_8000_winc_500_binc_500(self):
        self.brainlearn = Brainlearn(
    ...
    def test_go_movetime_200(self):
        self.brainlearn = Brainlearn("go movetime 200".split(" "), True)
        assert self.brainlearn.process.returncode == 0
    ...
    def test_d(self):
        self.brainlearn = Brainlearn("d".split(" "), True)
        assert self.brainlearn.process.returncode == 0

    def test_compiler(self):
        self.brainlearn = Brainlearn("compiler".split(" "), True)
        assert self.brainlearn.process.returncode == 0

    def test_license(self):
        self.brainlearn = Brainlearn("license".split(" "), True)
        assert self.brainlearn.process.returncode == 0

    def test_uci(self):
        self.brainlearn = Brainlearn("uci".split(" "), True)
        assert self.brainlearn.process.returncode == 0
    ...
    def test_network_equals_base(self):
        ...
        output = self.brainlearn.process.stdout
...
class TestInteractive(metaclass=OrderedClassMembers):
    ...
    def afterAll(self):
        self.brainlearn.quit()
        assert self.brainlearn.close() == 0
    ...
    def test_startup_output(self):
        self.brainlearn.starts_with("Brainlearn")

    def test_uci_command(self):
        self.brainlearn.send_command("uci")
        self.brainlearn.equals("uciok")

    def test_set_threads_option(self):
        self.brainlearn.send_command(f"setoption name Threads value {get_threads()}")

    def test_ucinewgame_and_startpos_nodes_1000(self):
        self.brainlearn.send_command("ucinewgame")
        self.brainlearn.send_command("position startpos")
        self.brainlearn.send_command("go nodes 1000")
        self.brainlearn.starts_with("bestmove")

    def test_ucinewgame_and_startpos_moves(self):
        self.brainlearn.send_command("ucinewgame")
        self.brainlearn.send_command("position startpos moves e2e4 e7e6")
        self.brainlearn.send_command("go nodes 1000")
        self.brainlearn.starts_with("bestmove")

    def test_fen_position_1(self):
        self.brainlearn.send_command("ucinewgame")
        self.brainlearn.send_command("position fen 5rk1/1K4p1/8/8/3B4/8/8/8 b - - 0 1")
        self.brainlearn.send_command("go nodes 1000")
        self.brainlearn.starts_with("bestmove")
    ...
    def test_fen_position_2_flip(self):
        self.brainlearn.send_command("ucinewgame")
        self.brainlearn.send_command("position fen 5rk1/1K4p1/8/8/3B4/8/8/8 b - - 0 1")
        self.brainlearn.send_command("flip")
        self.brainlearn.send_command("go nodes 1000")
        self.brainlearn.starts_with("bestmove")
    ...
    def test_depth_5_with_callback(self):
        self.brainlearn.send_command("ucinewgame")
        self.brainlearn.send_command("position startpos")
        self.brainlearn.send_command("go depth 5")
        ...
        self.brainlearn.check_output(callback)

    def test_ucinewgame_and_go_depth_9(self):
        self.brainlearn.send_command("ucinewgame")
        self.brainlearn.send_command("setoption name UCI_ShowWDL value true")
        self.brainlearn.send_command("position startpos")
        self.brainlearn.send_command("go depth 9")
    ...
    def test_clear_hash(self):
        self.brainlearn.send_command("setoption name Clear Hash")
    ...
    def test_fen_position_mate_1(self):
        ...
        self.brainlearn.send_command("go depth 18")

        self.brainlearn.expect("* score mate 1 * pv d5e6")
        self.brainlearn.equals("bestmove d5e6")
    ...
    def test_fen_position_mate_minus_1(self):
        ...
        self.brainlearn.send_command("go depth 18")
        self.brainlearn.expect("* score mate -1 *")
        self.brainlearn.starts_with("bestmove")
    ...
    def test_fen_position_fixed_node(self):
        ...
        self.brainlearn.send_command("go nodes 500000")
        self.brainlearn.starts_with("bestmove")
    ...
    def test_fen_position_with_mate_go_depth(self):
        ...
        self.brainlearn.send_command("go depth 18 searchmoves c6d7")
        self.brainlearn.expect("* score mate 2 * pv c6d7 * f7f5")
    ...
    def test_fen_position_with_mate_go_mate(self):
        ...
        self.brainlearn.send_command("go mate 2 searchmoves c6d7")
        self.brainlearn.expect("* score mate 2 * pv c6d7 *")
    ...
    def test_fen_position_with_mate_go_nodes(self):
        ...
        self.brainlearn.send_command("go nodes 500000 searchmoves c6d7")
        self.brainlearn.expect("* score mate 2 * pv c6d7 * f7f5")
    ...
    def test_fen_position_with_mate_go_depth_and_promotion(self):
        ...
        self.brainlearn.send_command("go depth 18")
        self.brainlearn.expect("* score mate 1 * pv f7f5")
        self.brainlearn.starts_with("bestmove f7f5")
    ...
    def test_fen_position_with_mate_go_depth_and_searchmoves(self):
        ...
        self.brainlearn.starts_with("bestmove c6d7")
    ...
    def test_fen_position_with_moves_with_mate_go_depth_and_searchmoves(self):
        ...
        self.brainlearn.send_command("go depth 18 searchmoves e3e2")
        self.brainlearn.expect("* score mate -1 * pv e3e2 f7f5")
        self.brainlearn.starts_with("bestmove e3e2")
    ...
    def test_verify_nnue_network(self):
        ...
        self.brainlearn.send_command("setoption name EvalFile value verify.nnue")
        self.brainlearn.send_command("position startpos")
        self.brainlearn.send_command("go depth 5")
        self.brainlearn.starts_with("bestmove")

    def test_multipv_setting(self):
        self.brainlearn.send_command("setoption name MultiPV value 4")
        self.brainlearn.send_command("position startpos")
        self.brainlearn.send_command("go depth 5")
        self.brainlearn.starts_with("bestmove")

    def test_fen_position_with_skill_level(self):
        self.brainlearn.send_command("setoption name Skill Level value 10")
        self.brainlearn.send_command("position startpos")
        self.brainlearn.send_command("go depth 5")
        self.brainlearn.starts_with("bestmove")

        self.brainlearn.send_command("setoption name Skill Level value 20")
...
class TestSyzygy(metaclass=OrderedClassMembers):
    ...
    def test_syzygy_setup(self):
        ...
        self.brainlearn.expect(
            "info string Found 35 WDL and 35 DTZ tablebase files (up to 4-man)."
        )

    def test_syzygy_bench(self):
        self.brainlearn.send_command("bench 128 1 8 default depth")
        self.brainlearn.expect("Nodes searched  :*")

    def test_syzygy_position(self):
        self.brainlearn.send_command("ucinewgame")
        self.brainlearn.send_command("position fen 4k3/PP6/8/8/8/8/8/4K3 w - - 0 1")
        self.brainlearn.send_command("go depth 5")
        ...
        self.brainlearn.check_output(check_output)
        self.brainlearn.expect("bestmove *")

    def test_syzygy_position_2(self):
        self.brainlearn.send_command("ucinewgame")
        self.brainlearn.send_command("position fen 8/1P6/2B5/8/4K3/8/6k1/8 w - - 0 1")
        self.brainlearn.send_command("go depth 5")
    ...
    def test_syzygy_position_3(self):
        self.brainlearn.send_command("ucinewgame")
        self.brainlearn.send_command("position fen 8/1P6/2B5/8/4K3/8/6k1/8 b - - 0 1")
        self.brainlearn.send_command("go depth 5")
...
def parse_args():
    parser = argparse.ArgumentParser(description="Run Brainlearn with testing options")
    ...
    parser.add_argument("brainlearn_path", type=str, help="Path to Brainlearn binary")
