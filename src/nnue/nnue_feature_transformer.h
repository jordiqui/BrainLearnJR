...
template<Brainlearn::Eval::NNUE::IndexType TransformedFeatureDimensions>
struct std::hash<Brainlearn::Eval::NNUE::FeatureTransformer<TransformedFeatureDimensions>> {
    std::size_t
    operator()(const Brainlearn::Eval::NNUE::FeatureTransformer<TransformedFeatureDimensions>& ft)
      const noexcept {
